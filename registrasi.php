...
<!-- body -->
    <div class="body"style="margin: 5rem;">
        ...
        <form action="" method="post">
            ...
            <p class="d-flex justify-content-center fst-italic" style="color:black;">Sudah punya akun?&nbsp<a href="login.php" style="color:#CDAC76;">Login</a> </p>
            
            <div class="d-flex justify-content-center" style="margin-top:75px;">
                <button class="btn" type="submit" name="register" style="background-color:#CDAC76; font-weight: 600; color:white; padding:10px 200px">Register</button>
            </div>
